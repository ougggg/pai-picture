...
export async function getUserProfileUsingGet(options?: { [key: string]: any }) {
...
/** updateUserProfile POST /api/user/profile/update */
export async function updateUserProfileUsingPost(
  body: API.UserEditRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseBoolean_>('/api/user/profile/update', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
