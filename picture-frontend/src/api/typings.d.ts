declare namespace API {
  type AiCreatePictureUsingPOSTParams = {
    /** text */
    text?: string
  }
  ...
  type BaseResponseCreatePortraitStyleRedrawTaskResponse_ = {
    code?: number
    data?: CreatePortraitStyleRedrawTaskResponse
    message?: string
  }
  ...
  type BaseResponseGetPortraitStyleRedrawTaskResponse_ = {
    code?: number
    data?: GetPortraitStyleRedrawTaskResponse
    message?: string
  }
  ...
  type CreatePicturePortraitStyleRedrawTaskRequest = {
    pictureId?: number
    styleIndex?: number
    styleRefUrl?: string
  }

  type CreatePortraitStyleRedrawTaskResponse = {
    code?: string
    message?: string
    output?: Output1
    requestId?: string
  ...
  type getPicturePortraitStyleRedrawTaskUsingGETParams = {
    /** taskId */
    taskId?: string
  }
  ...
  type GetPortraitStyleRedrawTaskResponse = {
    output?: Output3
    requestId?: string
    usage?: Usage
  }
  ...
  type PictureInteractionQueryRequest = {
    current?: number
    pageSize?: number
    sortField?: string
    sortOrder?: string
