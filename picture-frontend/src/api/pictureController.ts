...
/** AiCreatePicture POST /api/picture/ai_picture */
export async function aiCreatePictureUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.AiCreatePictureUsingPOSTParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseString_>('/api/picture/ai_picture', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** createPicturePortraitStyleRedrawTask POST /api/picture/portrait_style_redraw/create_task */
export async function createPicturePortraitStyleRedrawTaskUsingPost(
  body: API.CreatePicturePortraitStyleRedrawTaskRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseCreatePortraitStyleRedrawTaskResponse_>(
    '/api/picture/portrait_style_redraw/create_task',
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
/** getPicturePortraitStyleRedrawTask GET /api/picture/portrait_style_redraw/get_task */
export async function getPicturePortraitStyleRedrawTaskUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getPicturePortraitStyleRedrawTaskUsingGETParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseGetPortraitStyleRedrawTaskResponse_>(
    '/api/picture/portrait_style_redraw/get_task',
    {
      method: 'GET',
      params: {
        ...params,
